...
public class Kontakt implements Comparable<Kontakt>, Serializable {
     ...
     * @throws IllegalStateException wenn der name und die telefonNummer == null sind 
     */
    public Kontakt(String name, String telefon, String email){
        ...
        //wenn Parameter null ist dann IllegalStateException werfen
        if(name.isBlank() && telefon.isBlank()){
            throw new IllegalStateException("Name oder Telefon darf nicht freistehen");
        }
        this.name = name.trim();
